...
class Theme extends AbstractHelper
{
	...
	public function validate()
	{
		if (!$this->_path || !is_dir($this->_path)) {
			throw new \Exception('Empty or invalid path set.');
		}

		$themeIsActive = $this->_config->getOption('template') === 'fishpig'
			&& $this->_config->getOption('stylesheet') === 'fishpig';
		
		$themeFolder = $this->getPath() . DIRECTORY_SEPARATOR . 'wp-content'
			. DIRECTORY_SEPARATOR . 'themes' . DIRECTORY_SEPARATOR . self::THEME_NAME;
