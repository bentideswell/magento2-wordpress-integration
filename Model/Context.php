...
class Context implements \Magento\Framework\ObjectManager\ContextInterface
{
	 ...
	 * @return 
	 */
	public function __construct(App $app, ResourceConnection $resourceConnection, Url $urlBuilder, Config $config, ViewHelper $viewHelper, FilterHelper $filterHelper, CompatibilityHelper $compatibilityHelper)
	{
		$this->app = $app->init();
